...
export const TopNavBar: React.FC<TopNavBarProps> = ({
  ...
  return (
    <nav
      ...
      className={cn(
        'w-full h-[44px] px-4 flex items-center justify-between relative select-none bg-surface/90 backdrop-blur-md border-b border-border-subtle/50 shrink-0 z-20',
        className
      )}
    >
